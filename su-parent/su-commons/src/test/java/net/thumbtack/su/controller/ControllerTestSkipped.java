...
import net.thumbtack.su.Application;
...
public class ControllerTestSkipped {
    ...
    @Test
    public void getWelcomeScreen() throws Exception {
        ResponseEntity<String> response = template.getForEntity(baseURL.toString(), String.class);
        assertThat(response.getBody(), equalTo("Hello Sudokuer!"));
    }
}